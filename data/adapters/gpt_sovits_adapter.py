...
class GPTSoVITSAdapter(TTSInterface):
    ...
    async def synthesize(self, text: str, emotion: str = None, **kwargs) -> str:
        ...
        params = {
            "text": text,
            "text_language": kwargs.get("lang", "zh"),
            "refer_wav_path": kwargs.get("refer_wav_path", r"d:\AI\xiaoyou-core\ref_audio\female\ref_calm.wav"),
            "prompt_text": kwargs.get("prompt_text", "这是中文纯语音测试，不包含英文内容"),
            "prompt_language": kwargs.get("prompt_lang", "zh"),
        }
