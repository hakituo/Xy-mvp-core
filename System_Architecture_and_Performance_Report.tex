...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{P99 延迟}: xy-core (25.7s) 表现稳定，未出现极端长尾延迟，证明了优先级队列在高负载下的有效性。
    \end{itemize}
...
\begin{lstlisting}[caption=NVIDIA-SMI Snapshot (2025-12-08), basicstyle=\fontsize{6}{7}\selectfont\ttfamily, breaklines=false, frame=single, numbers=none]
