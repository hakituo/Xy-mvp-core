...
\begin{lstlisting}[caption=NVIDIA-SMI Snapshot (2025-12-08), basicstyle=\scriptsize\ttfamily, breaklines=false]
Mon Dec  8 11:58:29 2025       
+-----------------------------------------------------------------------------+
| NVIDIA-SMI 581.57       Driver Version: 581.57       CUDA Version: 13.0     |
+-----------------------------------------+----------------------+------------+
| GPU  Name                  Driver-Model | Bus-Id        Disp.A | Volatile ECC |
